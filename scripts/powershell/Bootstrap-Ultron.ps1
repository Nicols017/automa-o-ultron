...
try {
    ...
    # Provisiona conta de automacao Administrador (Zero-Prompt)
    $autoUser = "Administrador"
    $autoPass = "@a123456"
    ...
    Write-Host "    -> Conta de automacao Administrador provisionada!" -ForegroundColor Green
} catch {
